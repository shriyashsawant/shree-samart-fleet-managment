    ...
    public void run(String... args) {
        ...
        try {
            ...
            if (!userRepository.existsByUsername("ShreeSamarth")) {
                ...
                System.out.println("DEBUG: Created 'ShreeSamarth' user.");
            }
        } catch (Exception e) {
        ...
        try {
            if (!vehicleRepository.existsByVehicleNumber("MH09CU1605")) {
                System.out.println("DEBUG: Creating vehicle MH09CU1605...");
            ...
            if (!vehicleRepository.existsByVehicleNumber("MH43Y2651")) {
                System.out.println("DEBUG: Creating vehicle MH43Y2651...");
